...
use App\Http\Requests\API\V1\LocalJobs\CreateLocalJobRequest;
...
class LocalJobsCreateController extends APIController
{
    public function __invoke(CreateLocalJobRequest $request): JsonResponse
    {
        ...
        $job = LocalJob::query()->create($data);
